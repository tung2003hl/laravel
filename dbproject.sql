...
ALTER TABLE `food`
  ADD PRIMARY KEY (`id`),
  ADD KEY `food_shop_id_foreign` (`shop_id`);
...
ALTER TABLE `shippers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `shippers_order_id_foreign` (`order_id`),
  ADD KEY `shippers_shipper_id_foreign` (`shipper_id`);
...
--
ALTER TABLE `food`
  ADD CONSTRAINT `food_shop_id_foreign` FOREIGN KEY (`shop_id`) REFERENCES `shops` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `shippers`
  ADD CONSTRAINT `shippers_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `shippers_shipper_id_foreign` FOREIGN KEY (`shipper_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
